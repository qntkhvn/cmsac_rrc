...
header-includes:
 \author{Quang Nguyen\textsuperscript{1}\thanks{Corresponding author. Email\text{:} \texttt{nnguyen22@luc.edu}} , Gregory J. Matthews\textsuperscript{1}, Hannah Butler\textsuperscript{2} \vspace{2mm} \\
  \small \textsuperscript{1}Department of Mathematics and Statistics, Loyola University Chicago, \\
  \small Chicago, IL 60660 \\
  \small \textsuperscript{2}Department of Statistics, Colorado State University, \\
...
```{r corr, fig.cap="something", fig.height=3.5, fig.width=7.5}
library(tidyverse)
