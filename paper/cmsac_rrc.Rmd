...
```{r, fig.cap="The average scores for the top 10 qualification ranks and all 8 final ranks, obtained from simulations.", fig.height=3, fig.width=6.4}
final %>% 
  group_by(rank) %>% 
...
tribble(
  ...
  knitr::kable(caption = "Kendall's tau values, alongside correlation test statistics, p-values, and bootstrapped 95% confidence intervals, for the overall rank and the rank of speed, bouldering, and lead disciplines of Women's Qualification at Tokyo 2020.")
```
